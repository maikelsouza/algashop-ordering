...
public class ShoppingCart extends AbstractEventSourceEntity implements AggregateRoot<ShoppingCartId> {
    ...
    public void empty(){
        ...
        this.publishDomainEvent(new ShoppingCartEmptiedEvent(this.id(),
                this.customerId(), OffsetDateTime.now()));
    }
    ...
    public void addItem(Product product, Quantity quantity){
        ...
        publishDomainEvent(new ShoppingCartItemAddedEvent(this.id(),
                this.customerId, product.id(), OffsetDateTime.now()));
    }
    ...
    public void removeItem(ShoppingCartItemId shoppingCartItemId){
        ...
        publishDomainEvent(new ShoppingCartItemRemovedEvent(this.id(),this.customerId(),
